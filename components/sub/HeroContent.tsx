  ...
  return (
    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        <motion.div
          className="Welcome-box py-[8px] px-[7px] border border-[#7042f88b] opacity-[0.9] -ml-5 md:-ml-0"
        ...
        <motion.div
          ...
          className="flex flex-col gap-6 mt-6 text-3xl md:text-4xl lg:text-6xl font-bold text-white max-w-[600px] w-auto h-auto text-center md:text-left"
        >
          <span>
            Providing
